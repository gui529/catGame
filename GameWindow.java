...
public class GameWindow extends JFrame {
	...
	public Graphics dbg;
	private Image cat_pic,dog_pic,map_pic,still_cat,cat_dead,cat_left,cat_right,coin_pic,adog_pic;
	private Cat myCat;
	private Map map;
	private Coin coin;
	...
	//My Canvas that paints the game.
	public void paintComponent(Graphics g){
		...
		if (gamestart){
			...
			g.drawString(playerName+" | Score: "+score,  250,  100);
		...
		////MENU
			...
			username  = new JTextField("Type your name here");
	...
	public boolean moveCat(){
		...
		if (mouse.getXCoord() == myCat.getX() && mouse.getYCoord() == myCat.getY()) {
			cat_pic = still_cat; return false;		}
		if (myCat.getY() < 110) {
			myCat.setCatY(110);
			cat_pic = still_cat;
			return false;}
